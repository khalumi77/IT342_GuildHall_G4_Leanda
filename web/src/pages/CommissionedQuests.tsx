...
export default function CommissionedQuests() {
  ...
  const handleComplete = async (quest: CommissionedQuest) => {
    ...
    try {
      ...
      // Also update selected quest so the modal reflects the new status
...
const s: Record<string, React.CSSProperties> = {
  ...
  card: { backgroundColor: '#DDFFBC', borderRadius: '14px', border: '1.5px solid rgba(82,115,77,0.2)', display: 'flex', alignItems: 'stretch', overflow: 'hidden', transition: 'filter 0.15s' },
